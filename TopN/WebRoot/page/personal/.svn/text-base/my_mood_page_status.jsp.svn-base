					...
					<li  class="publish_content_li">
						...
						<span><s:property value="#fr.moodMsg" escape="false"/>
                                      ...
                                      <div class="mood_del_div">
                                             <a class="del_mood_a" onclick="deleteMood(this);" id="<s:property value="#fr.moodId"/>">x</a>
                                     </div>
									...
									<li>
										...
										<span class="operate_span"> <a
											onclick="reply_click(this)"> 回复 <input id="replyId"
													type="hidden" value="<s:property value="#fr.firstReplyId"/>" />
										</a> </span>
										<span class="operate_span"> <a
											onclick="deleteRply(this)"> 删除 <input id="hdreply_message_id"
													type="hidden" value="<s:property value="#fr.replyTopId"/>" />
										</a> </span>
									</li>
								</ul>
							</div>
							...
							<div class="reply_infomation_div">
								<ul>
									...
									<li>
										...
										<span class="operate_span"> <a
											onclick="reply_click(this)"> 回复 <input id="replyId"
													type="hidden" value="<s:property value="#fr.lastReplyId"/>" />
										</a> </span>
										<span class="operate_span"> <a
											onclick="deleteRply(this);"> 删除 <input id="hdreply_message_id"
													type="hidden" value="<s:property value="#fr.replyLastId"/>" />
										</a> </span>
									</li>
								</ul>
							</div>
					...
					<div class="reply_submit_div">
						<input type="hidden" id="parentId" name="parentId"
									...
									<input type="hidden" id="moodId" name="moodId"
										value="<s:property value="#fr.moodId"/>">
									<input type="button" id="reply_button" class="reply_button" name="publishReplyMyMood" onclick="clickReplyButton(this)"/>
					</div>
...
<s:if test="#frs.size() == 0">
		<center>
			<span style=" font-size: 12px">您还没有发表过什么</span>
		</center>
</s:if>
