...
import com.topn.nl.justobjects.pushlet.util.Rand;
import com.topn.nl.justobjects.pushlet.util.Sys;
...
public class SessionManager implements ConfigDefs {
	...
	/**
	 * 这里的sessionid产生方式做了修改
	 * Create new Session (but add later).
	 */
	public Session createSession(int id, Event anEvent) throws PushletException {
		// Trivial
		//return Session.create(createSessionId());
		return Session.create(String.valueOf(id));
	}
